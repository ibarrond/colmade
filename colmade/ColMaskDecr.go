...
func NewColMaskDecr(params bfv.Parameters, sk *rlwe.SecretKey, prng *utils.KeyedPRNG, maxMaskVal uint64) *ColMaskDecr {
...
func (mdcr *ColMaskDecr) DecryptMaskedNew(ct *bfv.Ciphertext) (ptOut *bfv.Plaintext) {
